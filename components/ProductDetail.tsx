      ...
      <div className="grid lg:grid-cols-2 gap-16 mb-24 items-center">
        ...
        <div className="lg:sticky lg:top-32 h-fit flex flex-col justify-center text-center">
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            <span className="text-3xl font-light dark:text-white">{formatPrice(product.price_rials)} {t('currency')}</span>
          ...
          <button 
            ...
            className="w-full py-4 bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 rounded-full font-bold text-lg hover:opacity-90 transition shadow-lg mb-4"
          >
            {t('feat_add')}
          </button>
          ...
          <button 
             ...
             className="w-full py-4 border-2 border-[#25D366] text-[#25D366] dark:text-[#25D366] rounded-full font-bold text-lg hover:bg-[#25D366] hover:text-white transition-all duration-300 shadow-lg mb-8 flex items-center justify-center gap-2"
          >
      ...
      <div className="border-t border-neutral-200 dark:border-neutral-800 pt-24 text-center">
        <div className="grid md:grid-cols-2 gap-12 items-center">
           <div className="flex flex-col items-center">
              <h3 className="text-3xl font-serif dark:text-white mb-6">{t('product_ritual')}</h3>
              <div className="space-y-6 w-full max-w-md">
                <div className="flex gap-4 items-center">
                  ...
                  <p className="text-neutral-600 dark:text-neutral-300 pt-1 text-left">{t('product_step1')}</p>
                </div>
                <div className="flex gap-4 items-center">
                  ...
                  <p className="text-neutral-600 dark:text-neutral-300 pt-1 text-left">{t('product_step2')}</p>
                </div>
              </div>
           </div>
